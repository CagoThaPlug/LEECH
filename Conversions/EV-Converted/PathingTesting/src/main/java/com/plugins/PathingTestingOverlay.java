...
public class PathingTestingOverlay extends Overlay {
    PathingTestingPlugin plugin;
    Client client;
    PathingTestingConfig config;
    PathingTestingOverlay(Client client, PathingTestingPlugin plugin,PathingTestingConfig config) {
        this.plugin = plugin;
        this.client = client;
        this.config = config;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        if(PathingTestingPlugin.fullPath ==null){
            return null;
        }
        int i =1;
        for (WorldPoint worldPoint : PathingTestingPlugin.fullPath) {
